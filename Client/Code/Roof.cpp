...
CRoof::CRoof(LPDIRECT3DDEVICE9 pGraphicDev)
...
HRESULT CRoof::Ready_GameObject(void)
{
...
void CRoof::Render_GameObject(void)
{
	_matrix matProj;
...
void CRoof::Set_Transform(Engine::CGameObject * pGameObjcet)
{
	...
	m_pTransformCom->m_vInfo[Engine::INFO_POS].y += 2.f;
...
HRESULT CRoof::Add_Component(void)
{
...
HRESULT CRoof::SetUp_Material(void)
{
...
CRoof* CRoof::Create(LPDIRECT3DDEVICE9 pGraphicDev)
{
	CRoof* pInstance = new CRoof(pGraphicDev);
