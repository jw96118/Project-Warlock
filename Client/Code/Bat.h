...
{
public:
	explicit CBat(LPDIRECT3DDEVICE9 pGraphicDev, const _tchar* pLayerTag, wstring wstrObjName, _vec3 vPos);
	virtual  ~CBat(void);
public:
...
public:
	static CBat*			Create(LPDIRECT3DDEVICE9 pGraphicDev, const _tchar* pLayerTag, wstring wstrObjName, _vec3 vPos = { 0,0,0 }, _int* pEventCount = nullptr);
