...
{
	ZeroMemory(&m_tResolution, sizeof(m_tResolution));
}
...
LPDIRECT3DDEVICE9 Engine::CGraphicDev::Get_Device(void) 
{ 
	return m_pGraphicDev; 
}

void CGraphicDev::Get_Resolution(RESOLUTION & tResolution) const
{
											...
											Engine::CGraphicDev** ppGraphicDev)
{
	...
	*ppGraphicDev = this;
	...
	m_tResolution.fWidth = (_float)iSizeX;
	m_tResolution.fHeigth = (_float)iSizeY;
