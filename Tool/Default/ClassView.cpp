...
void CClassView::FillClassView()
{
	...
	m_hPlayerClass = m_wndClassView.InsertItem(_T("Player"), 1, 1, hRootTop);

	m_hMonsterClass = m_wndClassView.InsertItem(_T("Monster"), 1, 1, hRootTop);
	m_hItemClass = m_wndClassView.InsertItem(_T("Item"), 1, 1, hRootTop);

	m_hMonster_Bat_Class     =  m_wndClassView.InsertItem(_T("박쥐"), 3, 3, m_hMonsterClass);
	m_hMonster_Spider_Class  = 	m_wndClassView.InsertItem(_T("거미"), 3, 3, m_hMonsterClass);
	m_hMonster_Shield_Class  = 	m_wndClassView.InsertItem(_T("방패"), 3, 3, m_hMonsterClass);
	m_hMonster_Ice_Class     =  m_wndClassView.InsertItem(_T("얼음"), 3, 3, m_hMonsterClass);
	m_hMonster_Middle_Class  =  m_wndClassView.InsertItem(_T("중간 보스"), 3, 3, m_hMonsterClass);
	m_hMonster_Boss_Class    =  m_wndClassView.InsertItem(_T("보스"), 3, 3, m_hMonsterClass);
...
void CClassView::UpdateList(Engine::OBJECTTYPE objTag, int testTag,CString str)
{
	...
	case Engine::OBJ_WALL:
		m_wndClassView.InsertItem(str, 3, 3, m_hWallClass);
		m_wndClassView.Expand(m_hWallClass, TVE_EXPAND);
		break;
	...
	case Engine::OBJ_MONSTER:
		...
		case Engine::MONSTER_BAT:
			m_wndClassView.InsertItem(str, 4, 4, m_hMonster_Bat_Class);
			m_wndClassView.Expand(m_hMonsterClass, TVE_EXPAND);
			break;
		case Engine::MONSTER_SPIDER:
			m_wndClassView.InsertItem(str, 4, 4, m_hMonster_Spider_Class);
			m_wndClassView.Expand(m_hMonsterClass, TVE_EXPAND);
			break;
		case Engine::MONSTER_SHIELD:
			m_wndClassView.InsertItem(str, 4, 4, m_hMonster_Shield_Class);
			m_wndClassView.Expand(m_hMonsterClass, TVE_EXPAND);
			break;
		case Engine::MONSTER_ICE:
			m_wndClassView.InsertItem(str, 4, 4, m_hMonster_Ice_Class);
			m_wndClassView.Expand(m_hMonsterClass, TVE_EXPAND);
			break;
		case Engine::MONSTER_MIDDLEBOSS:
			m_wndClassView.InsertItem(str, 4, 4, m_hMonster_Middle_Class);
			m_wndClassView.Expand(m_hMonsterClass, TVE_EXPAND);
			break;
		case Engine::MONSTER_BOSS:
			m_wndClassView.InsertItem(str, 4, 4, m_hMonster_Boss_Class);
			m_wndClassView.Expand(m_hMonsterClass, TVE_EXPAND);
			break;
	...
	case Engine::OBJ_ITEM:
		m_wndClassView.InsertItem(str, 3, 3, m_hItemClass);
		m_wndClassView.Expand(m_hItemClass, TVE_EXPAND);
		break;
	case Engine::OBJ_END:
		break;
	}
